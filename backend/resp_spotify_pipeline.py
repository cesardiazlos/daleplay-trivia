...
from models import Artist, Song, Category, EntityTypeEnum
        ...
        for index, item in enumerate(tracks, start=1):
            ...
            if not artist:
                ...
                artist = Artist(
                    ...
                    gender="Desconocido",                  # Default genérico
...
if __name__ == "__main__":
    ...
    test_id = "4fDbTNJtXTALJv95DahU68" 
    test_name = "TikTok Trends" # (O el nombre que le quieras dar)
